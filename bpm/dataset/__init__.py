...
def create_dataset(
  ...
  if name == 'market1501':
    ...
    im_dir = ospeu('/data1/LSPR/projects/RAP/beyond-part-models/data/rap2/images')
    partition_file = ospeu('/data1/LSPR/projects/RAP/beyond-part-models/data/rap2/partitions.pkl')
